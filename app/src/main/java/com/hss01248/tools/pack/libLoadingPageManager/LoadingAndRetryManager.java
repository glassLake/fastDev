package com.hss01248.tools.pack.libLoadingPageManager;
...
public class LoadingAndRetryManager
{
    ...
    public static View getCustomedEmptyView(String word){
        View view = View.inflate(BaseUtils.getContext(), R.layout.pager_empty,null);
